...
BooleanVector::~BooleanVector() { delete[] data_; }
...
uint32_t BooleanVector::getLenght() const { return numBits_; }
...
BooleanVector::Component_const
BooleanVector::operator[](const uint32_t index) const {
    uint32_t byteIndex = getByteIndex(index);
    uint32_t bitIndex = getBitIndex(index);
...
BooleanVector::Component::Component(uint8_t *const bytePtr,
...
BooleanVector::Component &
BooleanVector::Component::operator=(const bool value) {
...
BooleanVector::Component_const::Component_const(uint8_t *const bytePtr,
                                                const uint8_t bitIndex)
    : bytePtr_(bytePtr), bitIndex_(bitIndex) {}
