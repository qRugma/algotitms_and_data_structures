...
BooleanMatrix::BooleanMatrix(const char *data[], size_t rows)
    : data_(rows), rows_(rows) {
...
int BooleanMatrix::columns() const { return columns_; }
int BooleanMatrix::rows() const { return rows_; }
